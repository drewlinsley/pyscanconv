...
from typing import overload, Callable, Iterable, List, TypeVar, Any, Sequence, Optional
...
def associative_scan(operator, elems, axis=0, reverse=False):
    ...
    def _scan(elems):
        ...
        if num_elems % 2 == 0:
            ...
            even_elems = combine(odd_elems,[e[slice_along_axis(2, None, stride=2, axis=axis)] for e in elems])
